    ...
    <div style={{ maxWidth: 780, margin: '0 auto', padding: '20px 16px' }}>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 10, overflow: 'hidden' }}>
        ...
        <div style={{ padding: 16, borderBottom: '1px solid #f1f5f9' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 70px 100px 100px 32px', gap: 8, fontSize: 11, color: '#9ca3af', textTransform: 'uppercase', marginBottom: 4, padding: '0 2px' }}>
            <span>Description</span><span>Qty</span><span>Rate</span><span style={{ textAlign: 'right' }}>Amount</span><span />
          </div>
          {items.map((it, i) => (
            <div key={i} style={{ display: 'grid', gridTemplateColumns: '1fr 70px 100px 100px 32px', gap: 8, marginBottom: 6, alignItems: 'center' }}>
